# Migration `20200603053600-init`

This migration has been generated by nampdn at 6/3/2020, 5:36:00 AM.
...
"createdAt" timestamp(3)  NOT NULL DEFAULT CURRENT_TIMESTAMP,"endAt" timestamp(3)   ,"id" text  NOT NULL ,"leaderId" text   ,"name" text  NOT NULL ,"orgId" text   ,"slug" text   ,"stage" text  NOT NULL ,"startAt" timestamp(3)   ,"updatedAt" timestamp(3)  NOT NULL ,"year" integer   ,
    PRIMARY KEY ("id"))
